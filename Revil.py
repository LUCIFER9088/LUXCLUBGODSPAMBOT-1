...
async def start_luxspam():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await idk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await ydk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await wdk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await hdk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await sdk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await adk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await bdk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await cdk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await ddk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await edk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await vkk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await kkk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await lkk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await mkk(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await sid(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await shy(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await aan(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await ake(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await eel(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await khu(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await shi(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await yaa(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await dav(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await raj(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@LUXCLUB_SERGIO"))
            await put(functions.channels.JoinChannelRequest(channel="@BLUEBOTARENA"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
loop.run_until_complete(start_luxspam())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        luxspam = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(luxspam[0])
            text = "Changing Bio"
            ...
            try:
                ...
                await event.edit("Succesfully Changed Bio Now F*ck And Spam")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("SUCCESSFULLY JOINED, AB JA M# CH*D DE SABKI")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("SECRETLY JOINED, CHAL AB 100Rs PAYTM KAR FATAFAT")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        luxspam = ("".leave(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) == 7:
            bc = luxspam[0]
            bc = int(bc)
            text = "Trying Leaving....."
            ...
            try:
                ...
                await event.edit("Succesfully Left, BHAG AAYA BETA MAI")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                await event.client(LeaveChannelRequest(bc))
                await event.edit("SUCCESSFULLY LEFT, AB KISI AUR KI G&ND MARUNGA")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(luxspam) == 2:
            message = str(luxspam[1])
            counter = int(luxspam[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        luxspam = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        luxspamop = luxspam[1:]
        if len(luxspamop) == 2:
            message = str(luxspamop[1])
            counter = int(luxspamop[0])
            sleeptime = float(luxspam[0])
            for _ in range(counter):
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "ACTIVATED REPLY RAID, EK BAAP KA HAI TO AB BOLKE DIKHA BSDK"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "DE-ACTIVATED REPLY RAID, BETA AB TERI MA ME DAM NHI HAI BAHEN KO LEKE AANA AGLI BAAR"
            await e.reply(text, parse_mode=None, link_preview=None )
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def alive(e):
    if e.sender_id in SMEX_USERS:
        text = "  𝐋𝐔𝐗𝐂𝐋𝐔𝐁 𝐆𝐎𝐃𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 \n\n\n ʟᴜxᴄʟᴜʙ ɢᴏᴅsᴘᴀᴍ ɪs ᴀʟɪᴠᴇ ɴᴏᴡ, ғᴜᴄᴋ ᴛʜᴇ ᴋɪᴅs, ᴇɴᴊᴏʏ ʙᴀʙʏ !!\n\n ┏━━━━━━━━━━━━━━━━\n ┣⍟ ᴘʏᴛʜᴏɴ ᴠʀsɴ : 3.9.6\n ┣⍟ ᴛᴇʟᴇᴛʜᴏɴ ᴠʀsɴ : 1.17 \n ┣➣ sᴜᴘᴘᴏʀᴛ : @LUXCLUB_SERGIO\n ┣➣ ᴄʀᴇᴀᴛᴏʀ : RɪᴄʜRᴇᴀʟᴍ\n ┗━━━━━━━━━━━━━━━━\n "
        await e.reply(text, parse_mode=None, link_preview=None )
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐈𝐧 𝐋𝐔𝐗𝐂𝐋𝐔𝐁 𝐆𝐎𝐃𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 \n\n𝗨𝘁𝗶𝗹𝘀 𝗖𝗼𝗺𝗺𝗮𝗻𝗱:\n.alive\n.ping\n.restart\n\n𝗨𝘀𝗲𝗿𝗯𝗼𝘁 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀:\n.bio\n.join\n.leave\n.pjoin\n.pleave\n\n𝗦𝗽𝗮𝗺 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nFor more help regarding usage of plugins type plugin's name"
       await e.reply(text, parse_mode=None, link_preview=None )
...
print(text)
print("")
print("CONGRATS ! YOUR LUXCLUB GODSPAM BOT HAS STARTED SUCCESSFULLY. TYPE .ping OR .alive TO CHECK YOUR BOT'S ALIVE STATUS.")
